...
|---|---|---|
| `bun run test -- convex/production_proposals.test.ts` | Passed: 180 tests in the final implementation run | `LP-AC-PROP-05..LP-AC-PROP-07`, `LP-E2E-01`, `LP-E2E-04` |
| `bun run test -- src/features/production-proposals/ProposalLenderAssignmentSection.test.tsx` | Passed: 3 tests | `LP-PROT-ASSIGN`, `LP-VSG-01..LP-VSG-10` |
