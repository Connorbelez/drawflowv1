...
- Name: proposal-directory-controls-layout.spec.ts >> proposal directory controls stay inside the compact grid
- Location: tests/e2e/proposal-directory-controls-layout.spec.ts:45:1
