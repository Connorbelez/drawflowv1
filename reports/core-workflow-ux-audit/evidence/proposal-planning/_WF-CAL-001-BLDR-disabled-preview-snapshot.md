...
- dialog "Foundation":
  ...
  - paragraph: 2026-07-16 to 2026-08-15 · All day
  - button "Foundation actions":
  - text: Schedule
  - generic: Start date
  - textbox "Start date": 2026-07-16
  - generic: End date
  - textbox "End date": 2026-08-15
  - generic: Audit reason
  - textbox "Audit reason" [active]:
    - /placeholder: Record the reason for the schedule change.
    - text: UX audit dependency impact preview
