...
- button:
- generic: $200K
- dialog "New calendar event":
  - heading "New calendar event" [level=2]
  - paragraph: Reminder-only events stay on the calendar and do not change the build timeline, draw plan, or approval workflow.
  - generic: Title
  ...
  - checkbox "All day" [checked]:
  - checkbox [checked]
  - text: All day
  - generic: Timezone
  - textbox "Timezone": America/Toronto
  - generic: Invitees
  - checkbox "builder creator"
  - checkbox
  - generic: builder
  - generic: creator
  - checkbox "broker broker"
  - checkbox
  - generic: broker
  - generic: broker
  - checkbox "Connor Beleznay builder"
  - checkbox
  - generic: Connor Beleznay
  - generic: builder
  - checkbox "Connor Beleznay builder owner"
  - checkbox
  - generic: Connor Beleznay
  - generic: builder owner
  - button "Cancel"
