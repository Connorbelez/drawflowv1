...
- main:
  ...
  - separator
  - list:
    - button "Connor Beleznay Connor Beleznay c.beleznay@humanfeedback.com" [expanded]:
      - img "Connor Beleznay"
      - generic: Connor Beleznay
      - generic: c.beleznay@humanfeedback.com
    - menu "Connor Beleznay Connor Beleznay c.beleznay@humanfeedback.com" [active]:
      - group "Connor Beleznay Connor Beleznay c.beleznay@humanfeedback.com":
        - img "Connor Beleznay"
        - generic: Connor Beleznay
        - generic: c.beleznay@humanfeedback.com
      - separator
      - group "Active organization":
        - text: Active organization
        - paragraph: FairLendBrokerage
        - paragraph: Builder
      - group "Switch organization":
        - text: Switch organization
        - menuitem "FairLendBrokerage Builder" [disabled]:
