...
export async function resolveIntentSpecificOutcome(
  ctx: MutationCtx,
  input: {
...
export async function resolveQuestionOutcome(
  ctx: MutationCtx,
  input: {
    acceptedCommentId?: Id<"buildCollaborationComments">;
    authorization: ActiveBuildAuthorization;
...
export async function resolveIssueOutcome(
  ctx: MutationCtx,
  input: {
    authorization: ActiveBuildAuthorization;
    post: Doc<"buildCollaborationPosts">;
...
export function threadEventCommand(
  eventType:
    | "resolved"
    | "reopened"
    | "reply_reopened"
...
export async function requireManageablePost(
  ctx: MutationCtx,
  authorization: ActiveBuildAuthorization,
  postId: Id<"buildCollaborationPosts">
) {
...
export function requireExpectedThreadRevision(
  post: Doc<"buildCollaborationPosts">,
...
export function requireText(value: string, message: string, maxLength: number) {
...
export function threadStateSnapshot(post: Doc<"buildCollaborationPosts">) {
...
export async function loadVisibleAnswerOptions(
  ctx: QueryCtx,
  authorization: ActiveBuildAuthorization,
  post: Doc<"buildCollaborationPosts">
) {
...
export async function projectCommentRevisionForViewer(
  ctx: QueryCtx,
  input: {
    authorization: ActiveBuildAuthorization;
...
export async function loadOwnedDecisionRevisions(
  ctx: QueryCtx,
  authorization: ActiveBuildAuthorization,
  post: Doc<"buildCollaborationPosts">
) {
...
export async function postHasLinkedWork(
  ctx: QueryCtx | MutationCtx,
  authorization: ActiveBuildAuthorization,
  post: Doc<"buildCollaborationPosts">
) {
