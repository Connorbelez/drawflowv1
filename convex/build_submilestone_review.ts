...
const reviewDecisionDocValidator = v.object({
...
const siteVisitRequirementDocValidator = v.object({
  _creationTime: v.number(),
...
const siteVisitDocValidator = v.object({
  _creationTime: v.number(),
...
const recommendationResultValidator = v.object({
...
const changesRequestedResultValidator = v.object({
  decisionId: v.id("buildSubmilestoneReviewDecisions"),
  replayed: v.boolean(),
  reviewRound: v.number(),
...
const siteVisitWaivedResultValidator = v.object({
  decisionId: v.id("buildSubmilestoneReviewDecisions"),
  replayed: v.boolean(),
...
const childApprovedResultValidator = v.object({
  decisionId: v.id("buildSubmilestoneReviewDecisions"),
...
const childReopenedResultValidator = v.object({
  decisionId: v.id("buildSubmilestoneReviewDecisions"),
  replayed: v.boolean(),
  status: v.literal("reopened"),
});

const milestoneApprovedResultValidator = v.object({
  decisionId: v.id("buildMilestoneReviewDecisions"),
  replayed: v.boolean(),
  status: v.literal("approved"),
});

const milestoneReopenedResultValidator = v.object({
  decisionId: v.id("buildMilestoneReviewDecisions"),
  replayed: v.boolean(),
  status: v.literal("reopened"),
});
