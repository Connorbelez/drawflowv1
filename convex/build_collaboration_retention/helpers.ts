...
export function resolveRetentionPurgeReplay(
...
export async function findMatchingRetentionPurge(
  ctx: MutationCtx,
  input: {
...
export async function requireEligiblePurgeContext(
  ctx: MutationCtx,
  input: {
    authorization: Awaited<ReturnType<typeof authorizeLifecycleAuthority>>;
...
export async function deletePostTree(
  ctx: MutationCtx,
...
export async function deleteModerationCase(
  ctx: MutationCtx,
...
export async function deleteBuildResidue(
  ctx: MutationCtx,
...
export async function deleteArchiveResidueBatch(
  ctx: MutationCtx,
  buildId: Id<"activeBuilds">
) {
...
export async function deleteRemainingBuildResidue(
  ctx: MutationCtx,
  buildId: Id<"activeBuilds">,
...
export async function assertBuildCollaborationResidueRemoved(
  ctx: MutationCtx,
  buildId: Id<"activeBuilds">
) {
  const checks = [
...
export async function boundedAt<T>(
  promise: Promise<T[]>,
  limit: number,
  label: string
) {
