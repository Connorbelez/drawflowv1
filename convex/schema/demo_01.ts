...
export const schemaTables = {
  ...
  demo_siteVisits: defineTable({
    ...
    notesFormat: v.optional(schemaValidators.richTextFormatValidator),
  ...
  demo_timelineSnapshots: defineTable({
    activeSelection: schemaValidators.demoActiveMilestoneSelectionValidator,
    approvedDrawLimit: v.optional(v.number()),
    capitalSpikes: v.optional(
      v.array(schemaValidators.demoTimelineCapitalSpikeValidator)
    ),
    createdAt: v.number(),
    currentDay: v.optional(v.number()),
    draws: v.array(schemaValidators.demoTimelineDrawValidator),
    items: v.array(schemaValidators.demoTimelineItemValidator),
    minimumCashReserve: v.optional(v.number()),
    payloadVersion: v.literal(2),
    progressValue: v.number(),
    range: schemaValidators.demoTimelineRangeValidator,
  ...
  demo_timelinePlans: defineTable({
    ...
    status: schemaValidators.demoTimelinePlanStatusValidator,
