...
import {
  ...
  actionLabel,
  statusLabel,
} from "./contractor-quotes-prototype-variants.tsx";
import type {
  BuildGroup,
...
import {
  ...
  OpportunityQueue,
  PrototypeHeader,
} from "./contractor-quotes-workspace-prototype-surfaces.tsx";
      ...
      <FramePanel className="p-0">
        ...
        <div className="space-y-5 p-5">
          ...
          <p className="text-center text-muted-foreground text-xs">
            {request?.title} · response surface remains the existing QuoteFieldLedger
          </p>
        </div>
      </FramePanel>
    </Frame>
