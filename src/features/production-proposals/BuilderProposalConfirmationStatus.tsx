      ...
      <FramePanel className="space-y-4 p-5">
        ...
        {state.updateRequired ? (
          <Alert variant="destructive">
            ...
            <AlertTitle>
              Back Office is preparing an updated revision
            </AlertTitle>
            <AlertDescription>
              The current lender confirmation cycle requires an update. You do
              not need to take action here.
            </AlertDescription>
          </Alert>
        ) : status === "approved" ? (
          <Alert>
          ...
          <Alert>
            ...
            <AlertDescription>
              The current proposal revision is moving through its governed
              review cycle.
            </AlertDescription>
          </Alert>
        )}
