...
import type { BuilderBuildSearch } from "./index.tsx";
...
export function BuilderBuildWorkspaceRoute({
  ...
  const milestoneStartPrototypeVariant =
    import.meta.env.DEV && isMilestoneStartPrototypeVariant(search.variant)
      ? search.variant
      : undefined;
  const milestoneStartPrototypeEnabled = Boolean(
    ...
    <>
      ...
      {milestoneStartPrototypeVariant ? (
        ...
        <MilestoneExecutionSheetPrototype
          ...
          onExit={() => onChangePrototypeVariant(undefined)}
          onVariantChange={onChangePrototypeVariant}
          variant={search.variant as MilestonePrototypeVariant}
        />
      ) : null}
    </>
  );
