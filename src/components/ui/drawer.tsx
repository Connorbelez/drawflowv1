...
export function DrawerPopup({
  ...
  return (
    <DrawerPortal {...portalProps}>
      <DrawerBackdrop />
      <DrawerViewport
        className={allowContentTouch ? "touch-auto" : undefined}
        position={position}
        variant={variant}
      >
        <DrawerPrimitive.Popup
          className={cn(
            ...
            allowContentTouch ? "touch-auto" : "touch-none",
            position === "bottom" &&
...
export const DrawerContent = DrawerPopup;
