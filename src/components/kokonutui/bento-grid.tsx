...
import Anthropic from "#/components/kokonutui/anthropic.tsx";
import AnthropicDark from "#/components/kokonutui/anthropic-dark.tsx";
import DeepSeek from "#/components/kokonutui/deepseek.tsx";
import Google from "#/components/kokonutui/gemini.tsx";
import MistralAI from "#/components/kokonutui/mistral.tsx";
import OpenAI from "#/components/kokonutui/open-ai.tsx";
import OpenAIDark from "#/components/kokonutui/open-ai-dark.tsx";
    ...
    >
      <div className="flex flex-1 flex-col space-y-2">
        <div className="flex items-center justify-between">
          <div>
            {item.eyebrow ? (
              <p className="mb-2 font-semibold text-neutral-500 text-xs uppercase tracking-[0.18em] dark:text-neutral-400">
                {item.eyebrow}
              </p>
            ) : null}
  ...
  return (
    ...
    >
      {item.href ? (
        ...
        <div className={surfaceClassName}>{cardContent}</div>
      )}
    </motion.div>
  );
};

export const KokonutBentoCard = BentoCard;
